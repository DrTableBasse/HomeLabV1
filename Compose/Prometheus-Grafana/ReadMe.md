...
I just copy-pasta this [folder](https://github.com/docker/awesome-compose/tree/master/prometheus-grafana). It's a very awsome repository with a lot of docker-compose files
