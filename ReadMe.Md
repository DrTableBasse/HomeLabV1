...
| Service | Description |
|---------|-------------|
| [Pelican](https://pelican.dev) | Host game servers (Minecraft, Discord bots, etc.) |
...
- **RAM:** 64GB DDR5
- **Storage:** 1TB SSD
- **Networking:** Dual 2.5G NIC, WiFi 6E, Bluetooth 5.2
- **Ports:** HDMI 2.1, USB4, USB3.2 Gen 2, USB2.0
